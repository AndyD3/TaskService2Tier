...
public class WebLayerTest {
    ...
    public void shouldGetAll() throws Exception {
        ...
        taskList.add(new Task("title", "desc", "stat", LocalDate.now()));
        ...
        this.mockMvc.perform(get("/api/tasks")).andDo(print()).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].description", is("desc"))); //TODO convert to JSON object using serialiser as is less fragile
